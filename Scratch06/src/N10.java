...
public class N10 {
    ...
    public static void printMonthBody(int year, int month){
        ...
        // get number of the in the month
    ...
    // A stub for getTotalNumberOfDays
    public static int getTotalNumberOfDays(int year, int month){
        ...
        // And these two total value is total number of days
    ...
    // A stub for getNumberOfDaysInMonth
